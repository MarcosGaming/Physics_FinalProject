...
// FRICTION
glm::vec3 Friction::apply(float mass, const glm::vec3 &pos, const glm::vec3 &vel)
{
	...
	glm::vec3 fFriction = -direction * getFrictionCoefficient() * mass * glm::length(glm::vec3(0.0f,-9.8f,0.0f));
	return fFriction;
}
